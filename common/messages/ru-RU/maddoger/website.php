...
return [
    ...
    'Content' => 'Контент',
    'Counters JavaScript (before body content)' => 'Коды счетчиков JS (в начале тега body)',
    'Counters JavaScript (after body content)' => 'Коды счетчиков JS (в конце тега body)',
