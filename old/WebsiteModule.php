...
class WebsiteModule extends Module
{
    ...
    public function getConfigurationModel()
    {
        ...
        $model->addAttributes([
            ...
            'metaKeywords' => [
                'label' => Yii::t('maddoger/website', 'Meta keywords for all website'),
                'type' => 'textarea'
            ],
            'metaDescription' => [
                'label' => Yii::t('maddoger/website', 'Meta description for all website'),
                'type' => 'textarea'
            ],
            'headEndString' => [
                'label' => Yii::t('maddoger/website', 'Code before </head> closing tag.'),
                'type' => 'textarea'
            ],
            'bodyBeginString' => [
                'label' => Yii::t('maddoger/website', 'Code right after <body> opening tag.'),
                'type' => 'textarea'
            ],
            'bodyEndString' => [
                'label' => Yii::t('maddoger/website', 'Code before </body> closing tag.'),
                'type' => 'textarea',
                'hint' => Yii::t('maddoger/website', 'Use it for Google Analytics or Yandex Metrika counters.')
            ],
            'layouts' => [
                'label' => Yii::t('maddoger/website', 'Available layouts for pages'),
            ...
            'locales' => [
                'label' => Yii::t('maddoger/website', 'Available locales'),
    ...
    public function getRbacRoles()
    {
        return [
            'page.create' => [
                ...
                'description' => Yii::t('maddoger/website', 'Create new pages')
            ],
            'page.read' => ['type' => Item::TYPE_PERMISSION, 'description' => Yii::t('maddoger/website', 'View pages')],
            'page.update' => [
                'type' => Item::TYPE_PERMISSION,
                'description' => Yii::t('maddoger/website', 'Update pages')
            ],
            'page.delete' => [
                'type' => Item::TYPE_PERMISSION,
                'description' => Yii::t('maddoger/website', 'Delete pages')
            ],
            'page.manager' => [
                'type' => Item::TYPE_ROLE,
            ...
            'menu.manage' => [
                'type' => Item::TYPE_PERMISSION,
                'description' => Yii::t('maddoger/website', 'Manage menu')
            ],
            'menu.manager' => [
                'type' => Item::TYPE_ROLE,
            ...
            [
                ...
                'items' => [
                    ...
                    [
                        ...
                        'fa' => 'book',
                        'url' => ['/website/backend/pages/index'],
                        'activeUrl' => ['/website/pages/*'],
                        'roles' => ['pages.read']
                    ],
                    [
                        'label' => Yii::t('maddoger/website', 'Menu'),
                        'fa' => 'bars',
                        'url' => ['/website/backend/menu/index'],
                        'activeUrl' => ['/website/menu/*'],
                        'roles' => ['menu.manage'],
                    ],
                    [
                        'label' => Yii::t('maddoger/website', 'Settings'),
                        'fa' => 'gear',
                        'url' => [
                            '/admin/backend/modules/config',
                            'module' => 'website',
